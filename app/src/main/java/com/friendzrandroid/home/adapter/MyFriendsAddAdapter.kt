...
import com.friendzrandroid.home.fragment.home.messages.group.addUser.AddUserGroupViewModel

class MyFriendsAddAdapter(
    viewModel: AddUserGroupViewModel,
    private val listener: FeedRequestAdapterListener<FeedRequestUserData>,
    private val isGroupChatFragment: Boolean = false,
    private val selectedUsersIds: Array<String>? = null,
        ...
        when (viewType) {
            ...
            FeedKeyStatus.UPDATE_DECLINED_REQUEST.key -> { // inflate item_request_update
                ...
                return RequestUpdateViewHolder(
                    ...
                    listOfSelectedUsers = selectedUsersIds,
