package com.friendzrandroid.home.fragment.whiteLabel.ui
...
@AndroidEntryPoint
class CommunityAllFriendsFragment : BaseFragment(), FeedRequestAdapterListener<FeedRequestUserData> {
    ...
    override fun onCreateView(
        ...
        binding.tvInboxCreateConversation.setOnClickListener {
            val action = CommunityAllFriendsFragmentDirections.actionMyFriendsFragmentToCreateGroupFragment()
...
//       val userInbox =  InboxData(data.userId,data.image,false,"","","",false,data.displayedUserName)
        val action = CommunityAllFriendsFragmentDirections.actionFriendsFragmentToChatFragment(
            chatID = data.userId,
