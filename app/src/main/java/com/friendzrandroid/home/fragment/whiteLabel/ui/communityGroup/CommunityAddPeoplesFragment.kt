...
import com.friendzrandroid.databinding.FragmentCommunityPeopleBinding
...
import com.friendzrandroid.home.fragment.home.messages.allFriends.AllFriendsFragmentDirections
...
@AndroidEntryPoint
class CommunityAddPeoplesFragment : BaseFragment(), FeedRequestAdapterListener<FeedRequestUserData> {
    ...
    private val binding by lazy(LazyThreadSafetyMode.NONE) {
        FragmentCommunityPeopleBinding.inflate(layoutInflater)
    }
    ...
    override fun onCreateView(
        ...
        binding.tvInboxCreateConversation.setOnClickListener {
            ...
            val action = CommunityAddPeoplesFragmentDirections.actionCommunityPeoplesFragmentToCommunityCreateGroupFragment()
