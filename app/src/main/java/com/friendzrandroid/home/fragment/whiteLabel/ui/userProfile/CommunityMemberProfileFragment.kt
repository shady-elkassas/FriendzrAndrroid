package com.friendzrandroid.home.fragment.whiteLabel.ui.userProfile
...
import com.friendzrandroid.home.fragment.home.UserProfile.FeedRequestUserProfileFragmentArgs
import com.friendzrandroid.home.fragment.home.UserProfile.FeedRequestUserProfileFragmentDirections
import com.friendzrandroid.home.fragment.home.UserProfile.FeedRequestUserProfileViewModel
...
@AndroidEntryPoint
class CommunityMemberProfileFragment : BaseFragment() {
    ...
    private val binding by lazy(LazyThreadSafetyMode.NONE) {
        FragmentCommunityMemberProfileBinding.inflate(layoutInflater)
    }
...
//        binding.BtnsCurrentFriend.show()
        ...
        when (data.key) {
            FeedKeyStatus.YOU_BLOCK_USER.key -> {
                ...
                binding.btnUserProfileMessage.hide()
            ...
            FeedKeyStatus.NORMAL_FEED_STATE.key -> {
                binding.BtnsCurrentFriend.show()
                binding.btnUserProfileMessage.show()
    ...
    fun setClicks() {
        ...
        binding.BtnSendRequest.apply {
            setOnClickListener {
                ...
                if (binding.BtnSendRequest.tag as Int == RequestKeyStatus.SEND.key) showButtonLoading(
                ...
                else if (binding.BtnSendRequest.tag as Int == RequestKeyStatus.UN_BLOCK.key) {
                    ...
                    binding.BtnSendRequest.hide()
                    binding.btnUserProfileBlock.hide()
            ...
            if(profileStatusKey==4){
                ...
                MenuUtil(
                    ...
                    when (selectedMenuId) {
                        R.id.report -> {
                            val action =
                                CommunityMemberProfileFragmentDirections.actionCommunityMemberProfileFragmentToCommunityReportFragment(
...
*/
    ...
    private fun goToUserChat() {
        val action =
            CommunityMemberProfileFragmentDirections.actionCommunityMemberProfileFragmentToNavChatCommunity(
    ...
    private fun goToInbox() {
        val action =
            CommunityMemberProfileFragmentDirections.actionCommunityMemberProfileFragmentToNavMessagesCommunity()
        findNavController().navigate(action)
                ...
                R.id.block -> {
                    ConfirmationDialog(
                        ...
                        if (it == 1) viewModelFeedRequest.changeStatus(
                            userID,
                            RequestKeyStatus.BLOCK.key, true
                        )
