...
import com.friendzrandroid.databinding.FragmentIntro4Binding

class Intro4Fragment : Fragment() {
    private val binding by lazy(LazyThreadSafetyMode.NONE) {
        FragmentIntro4Binding.inflate(layoutInflater)
    }
    ...
    private fun openLogoView() {
        ...
        val filePlace =
            "android.resource://" + context!!.packageName + "/raw/" + com.friendzrandroid.R.raw.tutorial4
